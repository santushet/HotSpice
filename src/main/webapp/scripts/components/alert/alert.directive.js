        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('hotSpiceApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-hotSpiceApp-error');
                                var entityKey = httpResponse.headers('X-hotSpiceApp-params');
                                if (errorHeader) {
